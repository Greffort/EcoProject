...
namespace DelaunayTriangulator
{
            ...
            private void Analyse(List<Vertex> suppliedPoints, Hull hull, List<Triangle> triads, bool rejectDuplicatePoints, bool hullOnly)
        {
            ...
            public List<Triangle> Triangulation(List<Vertex> points)
            {
            ...
            bool FlipTriangle(List<Triangle> triads, int triadIndexToTest, out int triadIndexFlipped)
            {
                int oppositeVertex = 0, edge1, edge2, edge3 = 0, edge4 = 0;
                triadIndexFlipped = 0;

                Triangle tri = triads[triadIndexToTest];
                // test all 3 neighbours of tri 

                if (tri.bc >= 0)
                {
                    triadIndexFlipped = tri.bc;
                    Triangle t2 = triads[triadIndexFlipped];
            ...
            private void VerifyTriadContains(Triangle tri, int nbourTriad, int idA, int idB)
            {
            ...
            private void VerifyTriads(List<Triangle> triads, Hull hull)
            {
            ...
            private void WriteTriangles(List<Triangle> triangles, string name)
            {
